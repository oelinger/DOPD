                    ...
                    <div {...StyleX.props(style.content)}>
                        ...
                        <div {...StyleX.props(style.text)}>
                            ...
                            <article>
                                <h2>Cookies</h2>
                                <p>
                                    Diese Webseite verwendet nur unbedingt erforderliche Cookies die weder akzeptiert
                                    noch abgelehnt werden können. Sie gewährleisten lediglich die ordnungsgemäße
                                    funktionsweise dieser Website. Du hast jedoch die Möglichkeit, Cookies grundsätzlich
                                    im Browser zu deaktivieren.
                                </p>
                                <h3>Verwendete Cookies:</h3>
                                <p>
                                    Der Cookie „__cfduid“ wird von Cloudflare gesetzt und verwendet um
                                    vertrauenswürdigen Webverkehr zu identifizieren. Der Zweck dieses Cookies ist rein
                                    Funktional, es werden keine Daten gespeichert. Der Cookie hat eine
                                    Aufbewahrungsfrist von 30 Tagen.
                                </p>
                            </article>
                            <article>
                                ...
                                <p>
                                    ...
                                    Videos, Bilder, Beiträge etc.). Eingebettete Inhalte von anderen Websites verhalten
                                ...
                                <p>
                                    ...
                                    Inhalt, falls du ein Konto hast und auf dieser Website angemeldet bist.
                                </p>
                            </article>
                            <article>
                                <h2>Mit wem wir deine Daten teilen</h2>
                                <p>
                                    Grundsätzlich will D.O.P.D. keine Daten von dir sammeln oder teilen! Jedoch werden
                                    auf dieser Website Dienste verwendet um die Sicherheit und Schnelligkeit zu
                                    gewährleisten. Bitte entnehme deren Umgang mit Daten direkt aus deren
